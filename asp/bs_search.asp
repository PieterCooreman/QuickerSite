...
<tr><td valign="middle"><input type="text" value="<%=sanitize(Request.Form ("svalue"))%>" name="svalue" /></td><td valign="middle"><input class="art-button" type="submit" name="btnaction" value="<%=sanitize(l("search"))%>" /></td></tr></table></form><script type="text/javascript">document.bs.svalue.focus();</script><%dim postback
