...
if secondAdmin.bPageKeywords then%><tr><td class=QSlabel><%=l("keywords")%>:</td><td><input name="sKeywords" value="<%=sanitize(page.sKeywords)%>" type=text size=50 maxlength=2048 />&nbsp;<i>(META-tag keywords)</i></td></tr><%end if
