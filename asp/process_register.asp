...
pageBody=pageBody& "<div class='QS_fieldvalue'><input style=""width:200px"" size='30' maxlength='100' type='text' name='sEmail' value=" & """" & sanitize(Request("sEmail")) & """" &" /></div>"
pageBody=pageBody& "</div>"
pageBody=pageBody & "<div class='QS_fieldline'>"
pageBody=pageBody&"<div class='QS_fieldlabel'>"& l("captcha") &":</div>"
pageBody=pageBody & "<div class='QS_fieldvalue'><img src='" & C_DIRECTORY_QUICKERSITE & "/asp/includes/captcha.asp' alt='This is a CAPTCHA Image' style='vertical-align: middle;border-style:none;margin:0px 6px 0px 0px' /><input type='text' size='5' style='width:63px' maxlength='4' name='captcha' /></div>"
pageBody=pageBody & "</div>"
pageBody=pageBody& "<div class='QS_fieldline'>"
