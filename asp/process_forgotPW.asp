...
pageBody=pageBody & "<div class='QS_fieldvalue'><input type='text' style=""width:200px"" name='sEmail' size='30' value="& """" & sanitize(Request.Form ("sEmail")) &"""" &" /></div>"
pageBody=pageBody& "</div>"
pageBody=pageBody & "<div class='QS_fieldline'>"
pageBody=pageBody & "<div class='QS_fieldlabel'>"&l("captcha")&":</div>"
pageBody=pageBody & "<div class='QS_fieldvalue'><img src='" & C_DIRECTORY_QUICKERSITE & "/asp/includes/captcha.asp' style='vertical-align: middle;border-style:none;margin:0px 6px 0px 0px'><input style=""width:63px"" type='text' name='captcha' size='6' maxlength='4' /></div>"
pageBody=pageBody& "</div>"
pageBody=pageBody & "<div class='QS_fieldline'>"
